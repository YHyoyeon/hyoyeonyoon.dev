...
import { Mail, MapPin, Calendar, Send, User, Globe, Clock } from 'lucide-react'
  ...
  const contactInfo = [
    {
      icon: Mail,
      title: '이메일',
      value: 'gydus.dev@gmail.com',
      action: () => window.location.href = 'mailto:gydus.dev@gmail.com',
...
감사합니다.`)
    ...
    window.location.href = `mailto:gydus.dev@gmail.com?subject=${subject}&body=${body}`
  }
  ...
  return (
    <section id="contact" className="py-24 bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-cyan-500/10 rounded-full blur-lg"></div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            {contactInfo.map((info, index) => (
              ...
              >
                <div className={`bg-gradient-to-br ${info.bgColor} backdrop-blur-sm rounded-2xl p-8 border border-white/10 hover:border-white/20 transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/10`}>
                  <div className="flex items-start gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-700 text-lg font-medium mb-2">{info.value}</p>
          ...
          >
            ...
            <div className="bg-gradient-to-br from-emerald-50 to-green-50 backdrop-blur-sm rounded-2xl p-8 border border-emerald-200/50 shadow-xl">
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-3">구직 상태</h3>
                <div className="flex items-center justify-center gap-2 mb-4">
                  <div className="w-3 h-3 bg-emerald-500 rounded-full animate-pulse"></div>
                  <span className="text-emerald-700 font-semibold">열린 기회를 찾고 있습니다</span>
                </div>
                <p className="text-gray-600 leading-relaxed">
                  새로운 도전과 성장 기회를 기다리고 있습니다.
                  <br />
                  백엔드 개발부터 인프라, DevOps까지 폭넓은 경험을 바탕으로
                  <br />
